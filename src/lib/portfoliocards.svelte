        ...
        >
            <div class="space-y-4">
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    A Web applciation developed using SvelteKit, PostgreSQL, and Flask used by the Faculty and Students for managing departmental resources.
                </p>
                <a
                    href="#"
                    title=""
            ...
            <div class="space-y-4">
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    Personal discord bot used for managing home automation and other utility functions.
                </p>
                <a
                    href="#"
                    title=""
            ...
            <div class="space-y-4">
                ...
                <h3
                    class="text-2xl font-bold leading-tight text-gray-900 dark:text-white"
                >
                    Analysis of Fake News Proliferation in Twitter
                </h3>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    Understanding fake news proliferation through data analysis using Python and basic Natural Language Processing. 
                </p>
                <a
                    href="#"
                    title=""
            ...
            <div class="space-y-4">
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    Exploratory project that uses Python/Django to replicate an e-commerce store.
                </p>
                <a
                    href="#"
                    title=""
